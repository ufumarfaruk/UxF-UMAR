...
def sykology():
    ...
    uxf_code=input(" Choice [</] >")
    line()
    print(" Example 1000/2000/3000/4000")
    uxf_lim=int(input(" Choice [</] >"))
    line()
